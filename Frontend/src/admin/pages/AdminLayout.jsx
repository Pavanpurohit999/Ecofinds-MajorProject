...
export default function AdminLayout() {
    ...
    return (
        <div className="min-h-screen flex bg-[#f1f5f9] font-sans antialiased">
            {/* ── Sidebar ── */}
            <aside
                className="flex flex-col z-30 transition-all duration-300 ease-in-out flex-shrink-0"
            ...
            <div className="flex-1 flex flex-col h-screen overflow-hidden">
                ...
                <header className="h-14 bg-white border-b border-slate-200 flex items-center justify-between px-6 z-20 shadow-sm flex-shrink-0">
                    <div className="flex items-center gap-4">
                        <button className="text-slate-400 hover:text-slate-600 md:hidden" onClick={() => setSidebarOpen(!sidebarOpen)}>
                            <FiMenu size={22} />
                        </button>
